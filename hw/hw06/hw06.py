...
class VendingMachine:
    ...
    def add_funds(self, add):
        if self.number == 0:
            return f'Inventory empty. Restocking required. Here is your ${add}.'
        else:
            self.money+=add
...
class Coin:
    ...
    def worth(self):
        "*** YOUR CODE HERE ***"
        pass_year = Mint.current_year-self.year
        return self.cents + (0 if pass_year<=50 else pass_year-50)
